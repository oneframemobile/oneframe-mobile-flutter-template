...
import 'package:flutter_provider/ui/shared/widgets/view/notch_widget.dart';
          ...
          body: Container(
            child: Column(
              ...
              children: [
                ...
                buildSelectionButton(
                    selectedText: _selectCityViewModel.selectedCounty != null && _selectCityViewModel.selectedCounty.length != 0
                        ? _selectCityViewModel.selectedCounty[0].name
                        : "İlçe Seçin",
                    onClick: () {
                      buildShowDialog(
